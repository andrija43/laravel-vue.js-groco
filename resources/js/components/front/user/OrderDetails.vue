  ...
  <div id="modal-form" class="modal fade" aria-hidden="true">
    <div class="modal-dialog modal-custom">
      <div class="modal-content">
        <div class="modal-header text-right p5">
          <h3 class="modal-title ml10">
            Invoice<strong>#{{ order_no }}</strong>
          </h3>
          <button class="button button-xs br50" data-dismiss="modal">X</button>
        </div>
        <div class="modal-body">
          <div class="row pb-2 invoice-header">
            <div class="col-md-6">
              <div class="shipping-info-orderdetails">
          ...
          <div class="row mt15" v-if="!isLoading">
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="no-line"></td>
                      <td class="no-line"></td>
                      <td class="no-line">VAT / TAX</td>
                      <td class="no-line">
                        {{ currency.symbol }}
                        {{ order.vat_gst_amount | formatPrice }}
                      </td>
                    </tr>
                    <tr v-if="order.coupon_discount > 0">
                      ...
                      <td class="no-line">
                        {{ currency.symbol }}
                        {{
                            Number(order.shipping_amount) + Number(order.total_amount) + 
                             Number(order.vat_gst_amount)
                        }}
                      </td>
                    </tr>
                    <tr v-if="order.coupon_discount > 0">
                    ...
                    <tr>
                      ...
                      <td class="no-line">
                        {{ currency.symbol }}
                        {{
                          (Number(order.shipping_amount) + Number(order.total_amount) + Number(order.vat_gst_amount)) -
                          Number(order.coupon_discount) | formatPrice
                        }}
                      </td>
                    </tr>
                  </tbody>
          ...
          <div class="row">
            ...
            <div class="col-2 mt-4 text-r">
              <a
                :href="url + 'user-order-details-pdf/' + order_no"
                class="button button-sm float-center bg-blue color-white w80"
                >PDF</a
              >
