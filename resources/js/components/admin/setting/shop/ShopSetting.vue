    ...
    <div class="col-sm-8 b-r">
      ...
      <form @submit.prevent="save()" role="form">
        ...
        <div class="form-group">
          <label
            >User Login (<small
              >you can select User Login pattern</small
            >)</label
          >

          <select class="form-control" v-model="form.login_platform">
            <option value="0">Login with Email & Password</option>
            <option value="1">Login By OTP</option>
          </select>
        </div>
    ...
    getSetting() {
      axios
        ...
        .then((response) => {
          ...
          this.form.login_platform = response.data.login_platform;
