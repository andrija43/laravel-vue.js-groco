  ...
  <div class="row">
    <div class="col-sm-10">
      ...
      <form @submit.prevent="save()" role="form">
        ...
        <div class="form-group">
          <label>VAT/GST (VAT/GST percentage on Order amount)</label>
          <input
            v-model="form.vat_gst_amount"
            type="text"
            placeholder="GST on Order amount"
            class="form-control"
          />
        </div>
        ...
        <div class="form-group">
          ...
          <div class="switch">
            <div class="onoffswitch">
              <input
                type="checkbox"
                :checked="form.vat_gst_status == 1 ? true : false"
...
export default {
  ...
  methods: {
    getSetting() {
      axios
        ...
        .then((response) => {
          ...
          this.form.vat_gst_amount = response.data.vat_gst_amount;
          ...
          this.form.vat_gst_status = response.data.vat_gst_status;
    ...
    vatGstStatus: function () {
      axios.post(base_url + "admin/setting/vat-gst/status").then((response) => {
        if (response.data.status === "success") {
          this.successMessage(response.data);
          this.form.vat_gst_status = response.data.vat_gst_status;
          // EventBus.$emit('shipping-created');
