  ...
  <div class="wrapper wrapper-content">
    <div class="row" v-if="!isLoading">
      <div class="col-lg-2 tooltip-demo">
        ...
        >
          <div class="widget text-white p-lg text-center" style="background: linear-gradient(to right, #3358cb, #00bde0);">
            <div class="m-b-md">
      ...
      <div class="col-lg-2 tooltip-demo">
        ...
        >
          <div class="widget text-white p-lg text-center" style="background: linear-gradient(to right, #8452e7, #4d5ed0);">
            <div class="m-b-md">
      ...
      <div class="col-lg-2 tooltip-demo">
        ...
        >
          <div class="widget text-white p-lg text-center" style="background: linear-gradient(to right, #f3466c, #fb7636);">
            <div class="m-b-md">
      ...
      <div class="col-lg-2 tooltip-demo">
        <a
          ...
          title="Show Stock"
        >
          <div class="widget text-white p-lg text-center" style="background: linear-gradient(to right,#7D4196, #FF3494);">
            <div class="m-b-md">
      ...
      <div class="col-lg-2 tooltip-demo">
        ...
        >
          <div class="widget text-white p-lg text-center" style="background: linear-gradient(to right,#fe60a1, #ff8765);">
            <div class="m-b-md">
      ...
      <div class="col-lg-2 tooltip-demo">
        <a
          ...
          title="Manage Order"
        >
          <div class="widget text-white p-lg text-center" style="background: linear-gradient(to right, #5124b4, #964ebf);">
            <div class="m-b-md">
      ...
      <div class="col-lg-2 tooltip-demo">
        <a
          ...
          title="Manage Order"
        >
          <div class="widget text-white p-lg text-center" style="background: linear-gradient(to right, #8089ff, #54ceff);">
            <div class="m-b-md">
      ...
      <div class="col-lg-2 tooltip-demo">
        <a
          ...
          title="Manage Order"
        >
          <div class="widget text-white p-lg text-center" style="background: linear-gradient(to right, #25bbb6, #51cc7f)">
            <div class="m-b-md">
      ...
      <div class="col-lg-2 tooltip-demo">
        <a
          ...
          title="Manage Order"
        >
          <div class="widget text-white p-lg text-center" style="background: linear-gradient(to right, #FB834C, #EA6042);">
            <div class="m-b-md">
      ...
      <div class="col-lg-2 tooltip-demo">
        ...
        >
          <div class="widget text-white p-lg text-center"  style="background: linear-gradient(to right, #7a60ff, #cd9ffa)">
            <div class="m-b-md">
      ...
      <div class="col-lg-2 tooltip-demo">
        <a
          ...
          title="Manage Order"
        >
          <div class="widget text-white p-lg text-center" style="background: linear-gradient(to right, #FF9D6C, #BB4E75">
            <div class="m-b-md">
      ...
      <div class="col-lg-2 tooltip-demo">
        <a
          ...
          title="Manage Order"
        >
          <div class="widget text-white p-lg text-center" style="background: linear-gradient(to right, #e100ff, #7f00ff);">
            <div class="m-b-md">
